...
| [`tof-on-demand.md`](project/tof-on-demand.md) | The head ToF and IMU range and read for nobody. What it would take to gate them on a subscriber, and why starting and stopping the unit is not it. Decision wanted. |
